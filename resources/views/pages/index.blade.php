            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <h3>GRAFIK JUMLAH ARTIKEL BERITA BERDASARKAN KATEGORI BERITA</h3>
                        ...
                        Untuk menampilkan data kategori berita berdasarkan per bulan, silahkan pilih filter yang dibutuhkan. Untuk menampilkan data detailnya, silahkan klik pada bagian grafik.
                    </div>
            ...
            <div class="card mb-4">
                ...
                <h3>GRAFIK JUMLAH ARTIKEL BERITA BERDASARKAN TAG BERITA</h3>
                        ...
                        <div class="bd-callout bd-callout-info">
                            ...
                            Untuk menampilkan data tag berita berdasarkan per bulan, silahkan pilih filter yang dibutuhkan. Untuk menampilkan data detailnya, silahkan klik pada bagian grafik.
                        </div>
                    <!-- Dropdown untuk filter -->
            ...
            <div class="card mb-4">
                ...
                <h3>GRAFIK DENGAN JUMLAH ARTIKEL TERBANYAK BERDASARKAN DATA ARTIKEL WARTAWAN</h3>
                        ...
                        <div class="bd-callout bd-callout-info">
                            ...
                            Untuk menampilkan data jumlah artikel berita terbanyak per bulan, silahkan pilih filter yang dibutuhkan. Untuk menampilkan data detailnya, silahkan klik pada bagian grafik.
                        </div>
                    <!-- Dropdown untuk filter -->
