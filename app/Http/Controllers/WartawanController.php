...
class WartawanController extends Controller
{
    ...
    {
        $editor = Editor::with('user')->where('kuota', '!=', 0)->get();
    ...
    public function store(Request $request)
    {
        ...
        $editor = Editor::where('id_editor', $request->id_editor)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        $editor = Editor::where('id_editor', $data->id_editor)->first();
        ...
        $editorUpdate = Editor::where('id_editor', $request->id_editor)->first();
